...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Continent australia = new Continent("Australia", "title", "image");
            ...
            Trek e1 = new Trek("title1", "difficulty", "description", "review", "image", europe, europe1);
            Trek e2 = new Trek("title2", "difficulty", "description", "review", "image", europe, europe1);
            Trek e3 = new Trek("title3", "difficulty", "description", "review", "image", europe, europe2);
            Trek e4 = new Trek("title4", "difficulty", "description", "review", "image", europe, europe2);
